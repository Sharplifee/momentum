...
const CITY_OPTIONS = ["Lehi","Saratoga Springs","Eagle Mountain","American Fork","Pleasant Grove","Draper","Bluffdale","South Jordan","Riverton","Herriman","Sandy","Granite","Cottonwood Heights","West Jordan"];
    ...
    return (
      <main className="mx-auto max-w-lg p-8 text-center">
        ...
        <p className="text-stone-600">
          Norma, our scheduling assistant, is texting you now to get a personal quote visit on the
    ...
    <main className="mx-auto max-w-lg p-8">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <p className="text-xs text-stone-400">
          ...
          Norma). Msg&nbsp;&amp;&nbsp;data rates may apply. Reply STOP to opt out. See our{" "}
