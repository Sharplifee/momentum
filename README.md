...
- `app/api/*` — leads intake, SMS in/out, Norma, CAPI, crons, flow tester, health
...
- Norma never invents prices/dates; bookings only via `book_job`
...
`/api/leads` here, and Norma, who lives here and is reached over HTTP.
